...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Users can view their own NDA signatures" ON public.nda_signatures;
  DROP POLICY IF EXISTS "Users can create their own NDA signatures" ON public.nda_signatures;
